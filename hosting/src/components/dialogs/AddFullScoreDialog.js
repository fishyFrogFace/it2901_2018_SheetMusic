...
class AddFullScoreDialog extends React.Component {
    ...
    async open(pdf) {
        return new Promise(async (resolve, reject) => {
            ...
            const parts = pdf.parts.map(part => {
                const instr = instruments.find(
                    instrument => instrument.id === part.instrumentId
                );
    ...
    _onBackClick = () => {
        ...
        this.setState({
            activeStep: activeStep === 2 && !scoreCreated ? 0 : activeStep - 1,
            scoreCreated: false,
        });
    };
            ...
            >
                ...
                >
                    <Stepper activeStep={activeStep}>
                        <Step>
                            <StepLabel
                                icon={
                                    <StepIcon
                                        active={activeStep === 0 ? 1 : 0}
                                        completed={activeStep > 0 ? 1 : 0}
                                        number={1}
                                    />
                                }
                            >
                        ...
                        <Step>
                            <StepLabel
                                icon={
                                    <StepIcon
                                        active={activeStep === 1 ? 1 : 0}
                                        completed={scoreCreated ? 1 : 0}
                                        number={2}
                                    />
                                }
                            >
                        ...
                        <Step>
                            <StepLabel
                                icon={
                                    <StepIcon
                                        active={activeStep === 2 ? 1 : 0}
                                        completed={activeStep > 2 ? 1 : 0}
                                        number={3}
                                    />
                                }
                            >
                    ...
                    <div style={{ overflowY: 'auto', flex: 1 }}>
                        ...
                        {activeStep === 1 && (
                            <CreateScoreStep
                                defaultData={scoreData}
                                pdf={pdf}
                                onChange={this._onScoreDataChange}
                            />
                        )}
                        {activeStep === 2 &&
